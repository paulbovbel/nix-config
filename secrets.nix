...
in {
  "secrets/common/pbovbel-id_rsa.age".publicKeys = [pbovbel rainbow_wave white_tower pbovbel_dell media];
  "secrets/laptop/tailscale-oauth-authkey.age".publicKeys = [pbovbel rainbow_wave white_tower pbovbel_dell];
  "secrets/server/tailscale-oauth-authkey.age".publicKeys = [pbovbel media];
  "secrets/common/gmail-password.age".publicKeys = [pbovbel rainbow_wave white_tower pbovbel_dell media];
  "secrets/common/attic-watch-store-token.age".publicKeys = [pbovbel rainbow_wave white_tower pbovbel_dell media];
  "secrets/common/pbovbel-password-hash.age".publicKeys = [pbovbel rainbow_wave white_tower pbovbel_dell media];
